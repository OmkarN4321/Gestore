<script>
	...
	const addUser = async () => {
		let res = await fetch("https://pear-swallow-cap.cyclic.app:5000/user", {
			method: "POST",
	...
	const findUser = async () => {
		let res = await fetch(`https://pear-swallow-cap.cyclic.app:5000/user?email=${email}`);
		res = await res.json();
	...
	const updateUser = async (id) => {
		await fetch(`https://pear-swallow-cap.cyclic.app:5000/user/${id}`, {
			method: "PUT",
	...
	const deleteUser = async (id) => {
		await fetch(`https://pear-swallow-cap.cyclic.app:5000/user/${id}`, { method: "DELETE" });
